...
namespace WowKlient
{
	...
	void LoginManager::loginPrompt()
	{
		...
		//irr::gui::IGUIImage * loginButton = guienv->addImage(core::rect<s32>(loginButtonLeft, loginButtonTop, loginButtonLeft + loginButtonWidth, loginButtonTop + loginButtonHeight), loginBorder);
		...
		ps->setPosition(core::vector3df(100, 384, -150));
		...
		camera->setPosition(core::vector3df(512,384,0));

		//camera->setTarget(core::vector3df(512,384,-150));
		//camera->setRotation(core::vector3df(0, 196.249939, 0));
