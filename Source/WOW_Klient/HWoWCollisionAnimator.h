// Edited by Václav Macura (C) 2015
...
namespace scene
{
	class CSceneNodeAnimatorWoWCollisionAnimator : public ISceneNodeAnimatorCollisionResponse
	{
	public:

		//! constructor
		CSceneNodeAnimatorWoWCollisionAnimator(ISceneManager* scenemanager,
		...
		//! destructor
		virtual ~CSceneNodeAnimatorWoWCollisionAnimator();
